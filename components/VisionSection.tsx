...
export default function VisionSection() {
  return (
    <section className="relative z-10 bg-eggshell py-32 px-6 md:px-12">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
        <RevealOnScroll className="md:col-span-4">
          ...
          <h3 className="font-sans text-xs tracking-[0.25em] uppercase text-text-muted mb-4">
            The Vision
          </h3>
          <p className="font-display text-4xl leading-tight text-text-main">
        ...
        <RevealOnScroll className="md:col-span-8" style={{ transitionDelay: "0.2s" }}>
          <p className="text-xl font-light text-text-muted leading-relaxed max-w-2xl">
